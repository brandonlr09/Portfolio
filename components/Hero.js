  ...
  return (
    <div className="mb-5 max-w-2xl">
      ...
      <p className="mt-6 text-base text-gray-600 dark:text-gray-400">
        ...
        Passionate and driven programmer, I'm always looking for new opportunities to learn and grow. 
        Fueled by the energy of a dynamic team and invigorated by engaging challenges, I thrive on the constant evolution of technology.
        I approach each project with enthusiasm and a commitment to continuous learning.
      </p>
      <div className="mt-6 flex gap-6">
        <SocialLink
          href="https://github.com/brandonlr09"
          aria-label="Check out my Github"
          icon={IoLogoGithub}
        />
        <SocialLink
          href="https://www.linkedin.com/in/brandon-lessard-rook/"
          aria-label="Connect with me on LinkedIn"
          icon={IoLogoLinkedin}
        />
        <CopyToClipboard
          text={{ contact: 'brjobs09@hotmail.com', type: 'Email' }}
          aria-label="Send me an email"
          icon={IoMail}
        />
        <CopyToClipboard
          text={{ contact: '+1 (514) 971-6054', type: 'Phone number' }}
